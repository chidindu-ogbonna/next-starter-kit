    ...
    <div>
      <div className="relative overflow-hidden bg-white">
        <Head>
          ...
          <meta
            name="description"
            content="The perfect starter kit to make use"
          />
            ...
            <main className="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">The NextJS Kit</span>{" "}
                  <span className="block text-indigo-600 xl:inline">
                    to get you started
                  </span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  If you are building a smart home and want to take advantage of
                  the smart assistant Alexa, Amazon has two things you might
                  need for an Alexa-powered smart home. And today,
                </p>
      ...
      <div className="flex items-center justify-center px-4 py-52">
        <div className="w-full mx-4 text-center shadow-2xl card lg:w-1/3">
        ...
        <div className="w-full mx-4 text-center shadow-2xl card lg:w-1/3">
          <div className="card-body">
            ...
            <p>
              Building for the metaverse is hard. You need to be able to build
              for the future. And the future is here. And it&apos;s not just the
              future. It&apos;s the future itself.
            </p>
